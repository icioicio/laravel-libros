                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('books.update', $book->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" id="description" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('description', $book->description) }}</textarea>
                        </div>

                        <div class="mt-4">
                            <label for="publication_year" class="block font-medium text-sm text-gray-700">Año de Publicación</label>
                            <input type="number" name="publication_year" id="publication_year" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('publication_year', $book->publication_year) }}">
                        </div>
